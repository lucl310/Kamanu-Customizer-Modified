...
let stickervar = document.getElementById('sticker1')
...
function toolSwitch(type){
	if(type == 'bucket'){
		...
		hideStickers()
		ctx.globalCompositeOperation = "source-over"
		document.getElementById('tribalStickers').style.zIndex = "1";
	} else if(type == 'eraser'){
...
function resetZ(){
    ...
    document.getElementById('amaPic').style.zIndex = "1001";
    document.getElementById('deckPic').style.zIndex = "1001";
	document.getElementById('tribalStickers').style.zIndex = "1001";
...
function drop(ev, location) {
	...
	if(currentSticker == "tribalDesign"){
		if(location == "backDeck"){
			...
			placedSticker.setAttribute("onclick", "removeSticker(1)")
			...
			placedSticker.setAttribute("onclick", "removeSticker(2)")
		}
	} else if(currentSticker == "chevron"){
		if(location == "backDeck"){
			placedSticker.setAttribute("style", " transform: rotate(90deg); position: absolute; width: 2.4vw; height: auto; top: 76.25vh; left: 34%;")
			placedSticker.setAttribute("onclick", "removeSticker()")
		} else if(location == "frontDeck"){
			placedSticker.setAttribute("style", " transform: rotate(95deg); position: absolute; width: 1.65vw; height: auto; top: 77.5vh; left: 78.5%;")
			placedSticker.setAttribute("onclick", "removeSticker()")
		}
...
function showStickers(){
	stickervar.style.display = "inline"
	stickertextvar.style.display = "inline"
}

function hideStickers(){
	stickervar.style.display = "none"
	stickertextvar.style.display = "none"
}

function removeSticker(stickNum){
	if(sticknum == '1'){
		document.getElementById('tribalStickers').style.fill = "rgb(0,0,0)"
	}
}