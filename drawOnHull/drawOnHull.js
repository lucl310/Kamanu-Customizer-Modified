...
function drop(ev, location) {
	...
	placedSticker.setAttribute('width', '100.00000px')
	placedSticker.setAttribute('height', '200px')
...
function placeBack(stickerType){
	...
	stickerOnBack = true
	placedSticker.style = 'left:' + (mouseX - placedSticker.style.width) +'px; position: absolute;'
	console.log(mouseX)
...
function frontStickerZ(zValue){
	if(document.querySelectorAll('frontSticker').length >= 0){
...
function backStickerZ(zValue){
	if(document.querySelectorAll('backSticker').length >= 0){
...
function replaceSVG(location, stickerType){
	...
	if(location == "front"){
		...
		if(stickerType == 'turtle'){
			...
			placedImage.setAttribute("style", " transform: rotate(95deg); position: absolute; width: 1.6vw; height: auto; top: 80.25vh; left:" + (mouseX-placedImage.style.width) + "px;")
		} else if(stickerType == 'tribalDesign'){
			placedImage.setAttribute("ondragstart", "replaceDrag(event, 'tribalDesign', 'frontDeck')")
			placedImage.setAttribute("style", " transform: rotate(95deg); position: absolute; width: 1.6vw; height: auto; top: 77.5vh; left:" + (mouseX-placedImage.style.width) + "px;")
		}
