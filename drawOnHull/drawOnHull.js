...
function drop(ev, location) {
	...
	placedSticker.setAttribute('width', '100.000000px')
...
function placeBack(stickerType){
	...
	if(stickerType == 'turtle'){
		...
		iceCube.setAttribute('onMouseDown', 'svgDragging()')
	...
	stickerOnBack = true
	placedSticker.style = 'left: 34%; position: absolute;'
	backStickerZ('1001')
}
...
function placeFront(stickerType){
	...
	stickerOnFront = true
	placedSticker.style = 'left: 78.5%; position: absolute;'
	frontStickerZ('1001')
}
