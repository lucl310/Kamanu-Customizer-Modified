...
let iceCube;
let backSticker = document.getElementById('backSticker');
let frontSticker = document.getElementById('frontSticker');
...
function toolSwitch(type){
	if(type == 'bucket'){
		document.querySelectorAll("#frontSticker").forEach((frontSticker) => {
			frontSticker.style.zIndex = "8";
		})
		document.querySelectorAll("#backSticker").forEach((backSticker) => {
			backSticker.style.zIndex = "8";
		})
		shading.style.zIndex = "1001";
		amaShading.style.zIndex = "1001";
		amaPic.style.zIndex = "1001";
		deckPic.style.zIndex = "1001";
		composite_Image.style.zIndex = "1000";
		document.getElementById("frontDeck").style.zIndex = "1000";
		document.getElementById("backDeck").style.zIndex = "1000";
...
function placeBack(stickerType){
	...
	if(stickerType == 'turtle'){
		...
		iceCube.setAttribute('id', currentId)
		let dre = document.getElementById(currentId)
		console.log(currentId.toString() + " currentID")
		dre.setAttribute('fill', '#FFFFFF')
		...
		if(lineWidth == 5){
			...
			dre.setAttribute('transform', 'translate(-50.000000,550.000000) scale(0.07500000,-0.07500000)')
		} else if(lineWidth == 20){
			dre.setAttribute('transform', 'translate(-50.000000,650.000000) scale(0.100000,-0.100000)')
		}
		document.getElementById(currentId).parentElement.style.zIndex = '1001'
		...
		let nwa1 = []
		nwa1.push('iceCube1' + document.querySelectorAll('#backSticker').length + document.querySelectorAll('#frontSticker').length)
		console.log(nwa1)
		let currentId1 = nwa1[nwa1.length - 1]
		iceCube.setAttribute('id', currentId1)
		let dre = document.getElementById(currentId1)
		console.log(currentId1.toString() + " currentID")
		dre.setAttribute('fill', '#FFFFFF')
		placedSticker.setAttribute('onmousedown', 'replaceSVG("back", "tribalDesign", "iceCube1' + document.querySelectorAll('#backSticker').length.toString() + document.querySelectorAll('#frontSticker').length.toString() + '")')
		...
		dre.setAttribute('transform', 'translate(-100.000000,625.000000) scale(0.100000,-0.100000)')
		if(lineWidth == 5){
			dre.setAttribute('transform', 'translate(-100.000000,625.000000) scale(0.0500000,-0.0500000)')
		} else if(lineWidth == 10){
			dre.setAttribute('transform', 'translate(-100.000000,625.000000) scale(0.07500000,-0.07500000)')
		} else if(lineWidth == 15){
			dre.setAttribute('transform', 'translate(-100.000000,625.000000) scale(0.100000,-0.100000)')
		} else if(lineWidth == 20){
			dre.setAttribute('transform', 'translate(-100.000000,675.000000) scale(0.12500000,-0.12500000)')
		}
		document.getElementById(currentId1).parentElement.style.zIndex = '1001'
	}
...
function placeFront(stickerType){
	...
	if(stickerType == 'turtle'){
		...
		let nwa2 = []
		nwa2.push('iceCube2' + document.querySelectorAll('#backSticker').length + document.querySelectorAll('#frontSticker').length)
		console.log(nwa2)
		let currentId2 = nwa2[nwa2.length - 1]
		iceCube.setAttribute('id', currentId2)
		let dre = document.getElementById(currentId2)
		console.log(currentId2.toString() + " currentID")
		dre.setAttribute('fill', '#FFFFFF')
		placedSticker.setAttribute('onmousedown', 'replaceSVG("front", "turtle", "iceCube2' + document.querySelectorAll('#backSticker').length.toString() + document.querySelectorAll('#frontSticker').length.toString() + '")')
		placedSticker.style = 'left:' + (mouseX - 25 - (placedSticker.clientWidth/4)) +'px; top:' + (mouseY - (placedSticker.clientHeight/4) - 5) + 'px; position: absolute; transform: rotate(90deg);'
		dre.setAttribute('transform', 'translate(-50.000000,450.000000) scale(0.0500000,-0.0500000)')
		if(lineWidth == 5){
			dre.setAttribute('transform', 'translate(25.000000,375.000000) scale(0.02500000,-0.02500000)')
		...
		document.getElementById(currentId2).parentElement.style.zIndex = '1001'
	} else if(stickerType == 'tribalDesign'){
		...
		let nwa3 = []
		nwa3.push('iceCube3' + document.querySelectorAll('#backSticker').length + document.querySelectorAll('#frontSticker').length)
		console.log(nwa3)
		let currentId3 = nwa3[nwa3.length - 1]
		iceCube.setAttribute('id', currentId3)
		let dre = document.getElementById(currentId3)
		console.log(currentId3.toString() + " currentID")
		dre.setAttribute('fill', '#FFFFFF')
		placedSticker.setAttribute('onmousedown', 'replaceSVG("front", "tribalDesign", "iceCube3' + document.querySelectorAll('#backSticker').length.toString() + document.querySelectorAll('#frontSticker').length.toString() + '")')
		placedSticker.style = 'left:' + (mouseX - 25 - (placedSticker.clientWidth/4)) +'px; top:' + (mouseY - (placedSticker.clientHeight/4) + 10) + 'px; position: absolute; transform: rotate(90deg);'
		dre.setAttribute('transform', 'translate(-100.000000,625.000000) scale(0.100000,-0.100000)')
		if(lineWidth == 5){
			dre.setAttribute('transform', 'translate(-100.000000,625.000000) scale(0.0500000,-0.0500000)')
		...
		document.getElementById(currentId3).parentElement.style.zIndex = '1001'
	}
	placedSticker.setAttribute("ondragover", "allowDrop(event)")
...
function replaceSVG(location, stickerType, placedStickerId){
	...
	iceCube.setAttribute('fill', currentColor)
	console.log(placedStickerId)
	document.getElementById(placedStickerId).parentElement.remove()
	console.log(placedStickerId)
	if(stickerOnBack == false){
		while(document.querySelectorAll('#backStickerTemp').length >= 1){
			document.getElementById('backStickerTemp').remove()
		}
	}
	if(stickerOnFront == false){
		while(document.querySelectorAll('#frontStickerTemp').length >= 1){
			document.getElementById('frontStickerTemp').remove()
		}
	}
	sanityCheck()
}
...
function sanityCheck(){
	...
	if(stickerOnFront == false){
		while(document.querySelectorAll('#frontSticker').length >= 1){
			for(let i = document.querySelectorAll("#frontSticker").length; i > 1; i--){
				document.getElementById("frontSticker").remove()
			}
		}
	}
